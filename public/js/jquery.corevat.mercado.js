...
$(document).ready(function () {
	 ...
	 * 
	 ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++*/
	$('#idfactorubicacion_aemhomologacion').on("change", function () {
		$("#ubicacion_aemhomologacion").attr('min', $(this).find('option:selected').attr('min')).attr('max', $(this).find('option:selected').attr('max'));
	});
	 ...
	 * 
	 ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++*/
	$('#idfactorubicacion_aemanalisis').on("change", function () {
		$("#factor_ubicacion").attr('min', $(this).find('option:selected').attr('min')).attr('max', $(this).find('option:selected').attr('max'));
	});
