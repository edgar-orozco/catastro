        ...
        $.ajax({
            ...
            success: function(response){
                ...
                if(ajax_data.mode == 'query'){
                    ...
                    DlgOptions = {width:790, height:700, left: 100, top: 50, resizeable:true, newsize:false, container:'pmDlgContainerHyperlink'};
                    var dlg = PM.Dlg.createDnRDlg(DlgOptions, 'Resultado', false);
                    var str = response.domicilio; 
                    var res = str.slice(-23);
var h = "      <div>";
h += "        <br/>";
h += "        <table class = 'table table-condensed'cellspacing=\"0\" cellpadding=\"0\" border=\"0\" style=\"margin: 0 auto;\">";
h += "          <tbody>";
h += "            <tr>";
h += '                <td style="text-align: center";><img id="refMapImg" style="border-style: solid; border-color: #000" src="'+response.mapURL+'" alt=""></td>';
h += '                <td style="text-align: center";><img id="refMapImg" style="border-style: solid; border-color: #000" src="'+response.url_imagen+'" alt="" height="300" width="350"></td>';
h += "            </tr>";
h += "            <tr>";
h += '                <td style="text-align: left; font-weight: bold;">Clave Catastral: </td>' ;
h += '                <td>'+response.clave_catas+'</td>' ;
h += "            </tr>";
h += "            <tr>";
h += '                <td style="text-align: left; font-weight: bold;">Número de Cuenta: </td>' ;
h += '                <td>'+response.cuenta+'</td>' ;
h += "            </tr>";
h += "            <tr>";
h += '                <td style="text-align: left; font-weight: bold;">Municipio: </td>' ;
h += '                <td>'+response.municipio+'</td>' ;
h += "            </tr>";
h += "            <tr>";
h += '                <td style="text-align: left; font-weight: bold;">Propietario: </td>' ;
h += '                <td>'+response.propietario+'</td>' ;
h += "            </tr>";
h += "            <tr>";
h += '                <td style="text-align: left; font-weight: bold;">Calle y Número: </td>' ;
h += '                <td>'+response.domicilio+'</td>' ;
h += "            </tr>";
h += "            <tr>";
h += '                <td style="text-align: left; font-weight: bold;">Localidad: </td>' ;
h += '                <td></td>' ;
h += "            </tr>";
h += "            <tr>";
h += '                <td style="text-align: left; font-weight: bold;">Superficie de Terreno: </td>' ;
h += '                <td>'+response.sup_terr+' m2 </td>' ;
h += "            </tr>";
h += "            <tr>";
h += '                <td style="text-align: left; font-weight: bold;">Superficie de Construcción: </td>' ;
h += '                <td>'+response.sup_const+' m2</td>' ;
h += "            </tr>";
h += "            <tr>";
h += '                <td style="text-align: left; font-weight: bold;">Tipo de Predio: </td>' ;
h += '                <td>'+response.tipo_predio+'</td>' ;
h += "            </tr>";
h += "            <tr>";
h += '                <td style="text-align: left; font-weight: bold;">Último Pago de Impuesto (fecha/monto): </td>' ;
h += '                <td"></td>' ;
h += "            </tr>";
h += "            <tr>";
h += '                <td style="text-align: left; font-weight: bold;">Descargar Cédula: </td>' ;
h += '                <td><a class="btn btn-warning" href="/complementospdf/'+response.clave_catas+''+response.mapURL+'/'+res+'" target="_blank"><i class = "glyphicon glyphicon-cloud-download"> Descargar</i></a></td>' ;
h += "            </tr>";
h += "          </tbody>";
h += "        </table>";
h += "      </div>";
