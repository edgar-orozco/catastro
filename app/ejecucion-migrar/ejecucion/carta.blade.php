...
<script>
  ...
  $ ( "#myTable" ). tablesorter ({ sortList :  [[ 0 , 0 ],  [ 1 , 0 ]]  }); 
    ...
    <div class="panel-body">
             {{ Form::open(array(
                    'role' => 'form',
                    'method'=>'Ejecucion_BuscarController@getIndex',
                    'method' => 'GET'
                    ))
        }}
    ...
    {{ Form::open(array(
                    'role' => 'form',
                    'method'=>'Mostrar_HojaController@getIndex',
                    'method' => 'GET'
                    ))
        }}
    <div class="panel panel-primary">
    ...
    <tbody>
        ...
        @if(!empty($busqueda))
            ...
            <td>
                ...
                {{ Form::checkbox('prueba', $row->clave, false, array('class' => 'checkAll'))}}
            </td>
    ...
    {{ Form::submit('Generar Carta Invitacion', array('class' => 'btn btn-primary')) }}
</div>
</div>
