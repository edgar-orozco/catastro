...
<div class="row coveratCont">
	...
	<div class="col-md-6">
		<div class="form-group">
			...
			<div class="col-md-8">
				<select class="form-control" name="idestado" id="idestado" tabindex="10">
	...
	<div class="col-md-6">
		<div class="form-group">
			...
			<div class="col-md-8">
				<select class="form-control" name="idmunicipio" id="idmunicipio" tabindex="11">
	...
	<div class="col-md-12">
		...
		<div class="col-md-10">
			{{Form::text('altitud', $row->altitud, ['class'=>'form-control', 'id' => 'altitud', 'tabindex'=>'19', 'required' => 'required'])}}
		</div>
	</div>
