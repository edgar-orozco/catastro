...
@endif
{{ Form::model($row, ['route' => array('updateAvaluoGeneral', $row->idavaluo), 'method'=>'post', 'id' => 'formGeneral' ]) }}
...
<div class="row coveratCont">
	<div class="col-md-12">
		<div class="form-group">
			...
			<div class="col-md-10">
				{{Form::text('fecha_reporte', $row->fecha_reporte, ['class'=>'form-control', 'required' => 'required', 'maxlength' => '10', 'size' => '11', 'style' => 'width:110px', 'readonly'=>'readonly'])}}
	...
	<div class="col-md-12">
		<div class="form-group">
			...
			<div class="col-md-10">
				{{Form::text('fecha_avaluo', $row->fecha_avaluo, ['class'=>'form-control', 'required' => 'required', 'maxlength' => '10', 'size' => '11', 'style' => 'width:110px', 'readonly'=>'readonly'])}}
	...
	<div class="col-md-12">
		<div class="form-group">
			...
			<div class="col-md-10">
				{{Form::select('serie', array('U'=>'Urbano', 'R'=>'Rústico'), null, ['id' => 'serie', 'class'=>'form-control', 'style' => 'width:110px'])}}
			</div>
		</div>
	</div>
	<div class="col-md-12">
		<div class="form-group">
			...
			<div class="col-md-10">
				{{Form::text('proposito', $row->proposito, ['class'=>'form-control', 'required' => 'required', 'maxlength' => '250'])}}
	...
	<div class="col-md-12">
		<div class="form-group">
			...
			<div class="col-md-10">
				{{Form::select('fk_finalidad', $cat_finalidad, $row->fk_finalidad, ['id' => 'fk_finalidad', 'class'=>'form-control', 'required' => 'required'])}}
	...
	<div class="col-md-6">
		<div class="form-group">
			...
			<div class="col-md-8">
				{{Form::text('ubicacion', $row->ubicacion, ['class'=>'form-control', 'maxlength' => '300'])}}
			</div>
		</div>
	</div>
	...
	<div class="col-md-6">
		<div class="form-group">
			{{Form::label('conjunto', 'Conjunto : ', ['class'=>'col-md-4'])}}
			<div class="col-md-8">
				{{Form::text('conjunto', $row->conjunto, ['class'=>'form-control', 'maxlength' => '150'])}}
			</div>
		</div>
	</div>
    <!-- RENGLON 5 -->
	<div class="col-md-6">
		<div class="form-group">
			...
			<div class="col-md-8">
				{{Form::text('colonia', $row->colonia, ['class'=>'form-control', 'maxlength' => '150'])}}
			</div>
		</div>
	</div>
	<div class="col-md-6">
			...
			<div class="col-md-8">
				<select class="form-control" name="idmunicipio" id="idmunicipio">
					@foreach ($municipios as $municipio)
						@if ( $municipio->idmunicipio == $row->idmunicipio || $municipio->clave == $row->idmunicipio )
	...
	<div class="col-md-6">
		<div class="form-group">
			...
			<div class="col-md-4 col-md-offset-2" style="text-align: center;">
				<input type="radio" name="tp_coordenada" value="false" class="form-control tp_coordenada" tabindex="13" id="tp_coordenada_a" <?php if($row->tp_coordenada!= "1") { echo 'checked="checked"'; } ?> >
			</div>
		</div>
	</div>
	<div class="col-md-6">
		<div class="form-group">
			...
			<div class="col-md-4 col-md-offset-2" style="text-align: center;">
				<input type="radio" name="tp_coordenada" value="true" class="form-control tp_coordenada" tabindex="14" id="tp_coordenada_b" <?php if($row->tp_coordenada== "1") { echo 'checked="checked"'; } ?> >
			</div>
		</div>
	</div>
	...
	<div class="col-md-6">
		<div class="form-group">
			...
			<div class="col-md-6">
				<input type="text" class="form-control" name="sistema_coordenadas" id="sistema_coordenadas" tabindex="15" maxlength="50" value="{{$row->sistema_coordenadas}}" <?php if($row->tp_coordenada!= "1") { echo 'disabled="disabled"'; } ?> />
			</div>
		</div>
	</div>
	<div class="col-md-6">
		<div class="form-group">
			...
			<div class="col-md-6">
				<input type="text" class="form-control" name="datum" id="datum" maxlength="50" tabindex="16" value="{{$row->datum}}" <?php if($row->tp_coordenada!= "1") { echo 'disabled="disabled"'; } ?> />
			</div>
		</div>
	</div>
	...
	<div class="col-md-12">
		<div class="form-group">
			...
			<div class="col-md-10">
				{{Form::select('idregimenpropiedad', $cat_regimen_propiedad, $row->idregimenpropiedad, ['id' => 'idregimenpropiedad', 'class'=>'form-control', 'tabindex'=>'19'])}}
			</div>
		</div>
	</div>
	...
	<div class="col-md-12">
		<div class="form-group">
			...
			<div class="col-md-2">
				{{Form::text('cta_predial', null, ['class'=>'form-control', 'id' => 'cta_predial', 'disabled' => 'disabled', 'tabindex'=>'20'])}}
			</div>
			<div class="col-md-2">
				{{Form::number('numero_cuenta', null, ['id'=>'numero_cuenta','class'=>'form-control clsNumeric', 'step'=>'1', 'min'=>'0', 'max'=>'999999', 'maxlength' => '6', 'tabindex'=>'21'])}}
	...
	<div class="col-md-12">
		...
		<div class="col-md-1">
			{{Form::text('clv_catastral', null, ['class'=>'form-control', 'id' => 'clv_catastral', 'disabled' => 'disabled', 'tabindex'=>'22'])}}
		</div>

		{{Form::label('clave_zona', 'Clave Zona : ',['class'=>'col-sm-2'])}}
		<div class="col-md-1">
			{{Form::number('clave_zona', null, ['id'=>'clave_zona', 'class'=>'form-control clsNumeric', 'step'=>'1', 'min'=>'0', 'max'=>'999', 'maxlength' => '3', 'tabindex'=>'23'])}}
			{{$errors->first('clave_zona', '<span class=text-danger>:message</span>')}}
		</div>

		{{Form::label('clave_manzana', 'Clave Manzana : ',['class'=>'col-sm-2'])}}
		<div class="col-md-1">
			{{Form::number('clave_manzana', null, ['id'=>'clave_manzana', 'class'=>'form-control clsNumeric', 'step'=>'1', 'min'=>'0', 'max'=>'9999', 'maxlength' => '4', 'tabindex'=>'24'])}}
...
<script>
	$(document).ready(function () {
		...
		a = $("#cuenta_predial").val().split('-') ;
		$("#numero_cuenta").val( parseInt(a[2]) );

		$("#clv_catastral").val( $("#idestado").find('option:selected').attr('clave') + '-' + $("#idmunicipio").find('option:selected').attr('clave') + '-' );
		a = $("#cuenta_catastral").val().split('-') ;
		$("#clave_zona").val( a.length < 4 ? 0 : parseInt(a[2]) );
		$("#clave_manzana").val( a.length < 4 ? 0 : parseInt(a[3]) );
		$("#clave_predio").val( a.length < 4 ? 0 : parseInt(a[4]) );
