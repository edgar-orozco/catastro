	...
	<hr>
	{{Form::model($row, ['route' => array('updateAvaluoZona', $idavaluo), 'method'=>'post' ]) }}
	...
	<div class="row">
		...
		{{ Form::checkbox('is_otro_servicio', 1,  $row->is_otro_servicio) }}	
		</div>
		<div class="col-md-2"></div>
		<div class="col-md-5">
		{{Form::label('is_otro_equipamiento', 'Otros')}}
		{{ Form::checkbox('is_otro_equipamiento', 1,  $row->is_otro_equipamiento) }}	
		</div>
		
		<div class="col-md-5">
		{{Form::text('otro_servicio_municipal', $row->otro_servicio_municipal, ['class'=>'form-control', 'maxlength'=>'300'] )}}
		{{$errors->first('otro_servicio_municipal', '<span class=text-danger>:message</span>')}}
		<hr>
		</div>
		<div class="col-md-2"></div>
		<div class="col-md-5">
		{{Form::text('otro_equipamiento', $row->otro_equipamiento, ['class'=>'form-control', 'maxlength'=>'300'] )}}
