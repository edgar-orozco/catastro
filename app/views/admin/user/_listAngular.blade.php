<div class="panel">
    ...
    <div class="list-group" ng-show="users.length > 0 && !loading">
            <a class="list-group-item" style="cursor:pointer;" ng-click="edit($index)" dir-paginate="userList in users| searchBy:q:filterWord | itemsPerPage:itemsPage " current-page="currentPage" ng-class="(userList.id === user.id && !userList.error) ? 'active' : userList.error ? 'list-group-item-warning':''">
                <div class="row">
                    <div class="col-sm-9">
