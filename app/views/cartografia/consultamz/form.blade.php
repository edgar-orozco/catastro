...
<img src='{{$mapserv['ref_url']}}'>
	...
	<p> Municipio
	<br>{{Form::select('municipio', array( '0' => 'Seleccione---'), 'default', array( 'id' => 'municipio', 'OnChange'=>"ConsultaLadoServidor('localidad','tab_p_localidades','cve_mun',this.value,'nombre','nombre','nada','nada');"))}}
	<p> Localidad
	<br>{{Form::select('localidad', array( '0' => 'Seleccione---'), 'default', array( 'id' => 'localidad', 'OnChange'=>"ConsultaLadoServidor2('manzana','lim_colonias','nada',this.value,'numero_mzna','numero_mzna','nada','nada','nada','1');"))}}
...
<ul>
<table class="table">
<caption>Municipio: {{$mapserv['Municipio']}}<br> Manzana: {{$mapserv['Manzana']}}</caption>
