...
<div class="page-header">
    <h2>Generar <small>Cédula Catastral  Registral</small></h2>
</div>
...
<div class="panel-body">
   {{ Form::open(array('url'=> '/registralpdf')) }}
    <div class="row">
        <div>
    ...
    {{ Form::submit('Generar Cédula Registral', array('formtarget'=>'_blank','class' => 'btn btn-primary')) }}
    {{ Form::close() }}
        <div class="mensaje">
