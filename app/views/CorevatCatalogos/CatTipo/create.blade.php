...
<div class="row">
	...
	<div class="col-md-4">
        {{ Form::open(array('id'=>'form','url' => 'corevat/CatTipo/', 'method' => 'POST')) }}
		@include('CorevatCatalogos.CatTipo._form')
	...
	<div class="col-sm-8 col-md-8 col-lg-8">
		@include('CorevatCatalogos.CatTipo._list', compact('CatTipo'))<!--_list -->
	</div>
</div>
@stop
