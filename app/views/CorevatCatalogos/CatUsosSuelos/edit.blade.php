...
<div class="row">
	...
	<div class="col-md-4">
		{{ Form::model($row, ['route' => array('corevat.CatUsosSuelos.update', $row->idusossuelos ), 'method'=>'put' ]) }}
		@include('CorevatCatalogos.CatUsosSuelos._form', compact('CatUsosSuelos'))
		<div class="form-actions form-group">
			{{ Form::submit('Modificar registro', array('class' => 'btn btn-primary')) }}
			<a href="{{URL::route('corevat.CatUsosSuelos.index')}}" class="btn btn-warning" role="button">Cancelar</a>
		</div>
		{{Form::close()}}
    </div>
