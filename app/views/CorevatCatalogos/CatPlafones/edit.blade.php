...
<div class="row">
	...
	<div class="col-md-4">
		{{ Form::model($row, ['route' => array('corevat.CatPlafones.update', $row->idplafon ), 'method'=>'put' ]) }}
		@include('CorevatCatalogos.CatPlafones._form', compact('CatPlafones'))
		<div class="form-actions form-group">
			{{ Form::submit('Modificar registro', array('class' => 'btn btn-primary')) }}
			<a href="{{URL::route('corevat.CatPlafones.index')}}" class="btn btn-warning" role="button">Cancelar</a>
		</div>
		{{Form::close()}}
    </div>
