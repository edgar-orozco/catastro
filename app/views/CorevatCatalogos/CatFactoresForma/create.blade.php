...
<div class="row">
	...
	<div class="col-md-4">
        {{ Form::open(array('id'=>'form','url' => 'corevat/CatFactoresForma/', 'method' => 'POST')) }}
		@include('CorevatCatalogos.CatFactoresForma._form')
	...
	<div class="col-sm-8 col-md-8 col-lg-8">
		@include('CorevatCatalogos.CatFactoresForma._list', compact('CatFactoresForma'))<!--_list -->
	</div>
</div>
@stop
