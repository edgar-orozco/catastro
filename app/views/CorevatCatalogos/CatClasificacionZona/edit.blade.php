...
<div class="row">
	...
	<div class="col-md-4">
		{{ Form::model($row, ['route' => array('corevat.CatClasificacionZona.update', $row->idclasificacionzona ), 'method'=>'put' ]) }}
		@include('CorevatCatalogos.CatClasificacionZona._form', compact('CatClasificacionZona'))
		<div class="form-actions form-group">
			{{ Form::submit('Modificar registro', array('class' => 'btn btn-primary')) }}
			<a href="{{URL::route('corevat.CatClasificacionZona.index')}}" class="btn btn-warning" role="button">Cancelar</a>
		</div>
		{{Form::close()}}
    </div>
