...
<div class="row">
	...
	<div class="col-md-4">
		{{ Form::model($row, ['route' => array('corevat.CatEntrepisos.update', $row->identrepiso ), 'method'=>'put' ]) }}
		@include('CorevatCatalogos.CatEntrepisos._form', compact('CatEntrepisos'))
		<div class="form-actions form-group">
			{{ Form::submit('Modificar registro', array('class' => 'btn btn-primary')) }}
			<a href="{{URL::route('corevat.CatEntrepisos.index')}}" class="btn btn-warning" role="button">Cancelar</a>
		</div>
		{{Form::close()}}
    </div>
