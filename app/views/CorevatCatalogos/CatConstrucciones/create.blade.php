...
<div class="row">
	...
	<div class="col-md-4">
        {{ Form::open(array('id'=>'form','url' => 'corevat/CatConstrucciones/', 'method' => 'POST')) }}
		@include('CorevatCatalogos.CatConstrucciones._form')
	...
	<div class="col-sm-8 col-md-8 col-lg-8">
		@include('CorevatCatalogos.CatConstrucciones._list', compact('CatConstrucciones'))<!--_list -->
	</div>
</div>
@stop
