...
<div class="row">
	...
	<div class="col-md-4">
		{{ Form::model($row, ['route' => array('corevat.CatAcabados.update', $row->id ), 'method'=>'put' ]) }}
		@include('CorevatCatalogos.CatAcabados._form', compact('CatAcabados'))
		<div class="form-actions form-group">
			{{ Form::submit('Modificar registro', array('class' => 'btn btn-primary')) }}
			<a href="{{URL::route('corevat.CatAcabados.index')}}" class="btn btn-warning" role="button">Cancelar</a>
		</div>
		{{Form::close()}}
	</div>
