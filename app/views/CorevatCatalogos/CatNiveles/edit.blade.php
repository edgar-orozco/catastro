...
<div class="row">
	...
	<div class="col-md-4">
		{{ Form::model($row, ['route' => array('corevat.CatNiveles.update', $row->idnivel ), 'method'=>'put' ]) }}
		@include('CorevatCatalogos.CatNiveles._form', compact('CatNiveles'))
		<div class="form-actions form-group">
			{{ Form::submit('Modificar registro', array('class' => 'btn btn-primary')) }}
			<a href="{{URL::route('corevat.CatNiveles.index')}}" class="btn btn-warning" role="button">Cancelar</a>
		</div>
		{{Form::close()}}
    </div>
