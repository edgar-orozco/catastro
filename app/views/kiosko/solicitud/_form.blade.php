...
<div class="panel panel-default">
    ...
    <div class="panel-body">
        <div class="col-md-4">
           ...
           {{Form::text('solicitante[nombres]', null, ['placeholder'=>'Nombres del Solicitante','tabindex'=>'4','class'=>'form-control', 'autofocus'=> 'autofocus', 'required' => 'required', 'ng-model' => 'solicitante.nombres', 'tb-focus' => 'focusForm', 'ng-blur' => 'focusForm = false'] )}}
        ...
        <div class="col-md-4">
           ...
           {{Form::text('solicitante[apellido_paterno]', null, ['placeholder'=>'Apellido Paterno del Solicitante','tabindex'=>'5','class'=>'form-control', 'autofocus'=> 'autofocus', 'ng-model' => 'solicitante.apellido_paterno', 'tb-focus' => 'focusForm', 'ng-blur' => 'focusForm = false'] )}}
        ...
        <div class="col-md-4">
           ...
           {{Form::text('solicitante[apellido_materno]', null, ['placeholder'=>'Apellido Materno del Solicitante','tabindex'=>'6','class'=>'form-control', 'autofocus'=> 'autofocus', 'required' => 'required', 'ng-model' => 'solicitante.apellido_materno', 'tb-focus' => 'focusForm', 'ng-blur' => 'focusForm = false'] )}}
           {{$errors->first('solicitante[apellido_materno]', '<span class=text-danger>:message</span>')}}
        </div>
        <div class="col-xs-6">
           {{Form::label('solicitante[curp]','CURP')}} 
           {{Form::text('solicitante[curp]', null, ['placeholder'=>'CURP del Solicitante','tabindex'=>'7','class'=>'form-control', 'autofocus'=> 'autofocus', 'required' => 'required', 'ng-model' => 'solicitante.curp', 'tb-focus' => 'focusForm', 'ng-blur' => 'focusForm = false'] )}}
           {{$errors->first('solicitante[curp]', '<span class=text-danger>:message</span>')}}
        </div>
        <div class="col-xs-6">
           {{Form::label('solicitante[rfc]','RFC')}} 
           {{Form::text('solicitante[rfc]', null, ['placeholder'=>'RFC del Solicitante','tabindex'=>'8','class'=>'form-control', 'autofocus'=> 'autofocus', 'required' => 'required', 'ng-model' => 'solicitante.rfc', 'tb-focus' => 'focusForm', 'ng-blur' => 'focusForm = false'] )}}
           {{$errors->first('solicitante[rfc]', '<span class=text-danger>:message</span>')}}
        </div>
        <div class="col-md-4">
           {{Form::label('solicitante[tipo_telefono]','Tipo Telefono')}} 
           {{Form::select('solicitante[tipo_telefono]',$tipo_telefono, null,['tabindex'=>'9','class'=>'form-control','autofocus'=> 'autofocus', 'required' => 'required', 'ng-model' => 'solicitante.tipo_telefono', 'tb-focus' => 'focusForm', 'ng-blur' => 'focusForm = false'])}}
           {{$errors->first('solicitante[tipo_telefono]', '<span class=text-danger>:message</span>')}}
        </div>
        <div class="col-md-4">
           {{Form::label('solicitante[telefono]','Telefono')}} 
           {{Form::text('solicitante[telefono]', null, ['placeholder'=>'Telefono del Solicitante','tabindex'=>'10','class'=>'form-control', 'autofocus'=> 'autofocus', 'required' => 'required', 'ng-model' => 'solicitante.telefono', 'tb-focus' => 'focusForm', 'ng-blur' => 'focusForm = false'] )}}
           {{$errors->first('solicitante[telefono]', '<span class=text-danger>:message</span>')}}
        </div>
        <div class="col-md-4">
           {{Form::label('solicitante[correo]','E-mail')}} 
           {{Form::email('solicitante[correo]', null, ['placeholder'=>'E-mail del Solicitante','tabindex'=>'11','class'=>'form-control', 'autofocus'=> 'autofocus', 'required' => 'required', 'ng-model' => 'solicitante.correo', 'tb-focus' => 'focusForm', 'ng-blur' => 'focusForm = false'] )}}
           {{$errors->first('solicitante[correo]', '<span class=text-danger>:message</span>')}}
        </div>
        <div class="col-md-12">
           {{Form::label('solicitante[direccion]','Dirección')}} 
           {{Form::text('solicitante[direccion]', null, ['placeholder'=>'Dirección del Solicitante','tabindex'=>'12','class'=>'form-control', 'autofocus'=> 'autofocus', 'required' => 'required', 'ng-model' => 'solicitante.direccion', 'tb-focus' => 'focusForm', 'ng-blur' => 'focusForm = false'] )}}
