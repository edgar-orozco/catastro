        ...
        @if(count($items) > 0)
            ...
            <div class="panel-default">
                ...
                <table id="myTable" class="table">
                    ...
                    <tr>
                        <th width="100"><P
                                    align="center">{{ Form::checkbox('checkMain', 'checkMain', false, array('name' => 'checktodos'))}}</P>
                        </th>
                    ...
                    @foreach ($pagination as $key )
                        ...
                        <tr>
                            ...
                            <td align="center">
                                ...
                                @if($requerimiento=='Si')
                                    @if($fechainicio=='' || $fechaven=='')
                                        <a data-toggle="modal" class="editar-ejecucion"
                                           data-requerimiento="{{$idrequerimiento}}" data-target="#Nuevo"
                                           href="/ejecucion/modal/{{$idrequerimiento}}"
                                           title="Agregar Requerimiento"><span
                            ...
                            <td>
                                <a data-toggle="modal" data-cancelar="{{$idrequerimiento}}" class="cancelar-ejecucion"
                                   data-target="#cancelar" href="/ejecucion/cancelar/{{$idrequerimiento}}"
                                   title="Cancelar Requerimiento"><span class="glyphicon glyphicon-remove"></span></a>
