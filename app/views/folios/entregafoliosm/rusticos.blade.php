...
<div class="panel panel-default">
	...
	{{Form::close()}}
		...
		<div id="tablaAjax">
			@include('folios.entregafoliosm.tablaAjax')
		</div>
	...
	$('#searchField').bind('input keyup', function()
	{
	    ...
	    $this.data('timer', setTimeout(function()
	    {
	    	...
	    	$.get('/entregafoliosmunicipal/tablaAjax/buscar', { buscar: $('#searchField').val(), id: getPath(3), tipo_folio: 'R' }, function(data) 
	    	{
		   		$('#tablaAjax').html(data);
	    	});
	...
	$(document).on('click', '.pagination a', function(e)
	{
		...
		$.get('/entregafoliosmunicipal/tablaAjax/?page='+page+'&id='+ id + '&tipo_folio=R'+'&year='+ year, function(data)
		{
			$('#tablaAjax').html(data);
		});
