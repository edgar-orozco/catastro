  ...
  $fechas=date_parse($fecha);
      $fecha = array();
        ...
        <div class="invitacionPage">
            ...
            <!-- nuevo fotmato -->
            <p align="center">
H. AYUNTAMIENTO DEL MUNICIPIO DE HUIMAGUILLO, TABASCO.<br/>
