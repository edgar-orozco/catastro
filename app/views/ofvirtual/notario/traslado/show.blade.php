...
{{ HTML::style('css/forms.css') }}
   ...
   <tr>
     ...
     <tr>
       ...
       <td>{{$traslado->vendedor['nombres']}} {{$traslado->vendedor['ap_paterno']}} {{$traslado->vendedor['ap_materno']}}</td>
   </tr>
<!-- Persona física -->
       <tr>
 ...
 {{--Comprador --}}
   ...
   <th class="text-right"><b>Tipo Persona:</b></th>
     ...
     <tr>
       <th class="text-right"><b>Nombre:</b></th>
       <td>{{$traslado->comprador['nombres']}} {{$traslado->comprador['ap_paterno']}} {{$traslado->comprador['ap_materno']}}</td>
    </tr>
