...
class inpcSeeder extends Seeder {
    public function run()
    {
      ...
      DB::table('inpc')->insert(
            array('mes' => 8,'anio' => 2015 ,'inpc'=>116.373, 'usuario'=>$usuario )
                );

      DB::table('inpc')->insert(
            array('mes' => 9,'anio' => 2015 ,'inpc'=>116.809, 'usuario'=>$usuario )
                );

      DB::table('inpc')->insert(
            array('mes' => 10,'anio' => 2015 ,'inpc'=>117.410, 'usuario'=>$usuario )
                );

      DB::table('inpc')->insert(
            array('mes' => 11,'anio' => 2015 ,'inpc'=>118.051, 'usuario'=>$usuario )
                );

      DB::table('inpc')->insert(
            array('mes' => 12,'anio' => 2015 ,'inpc'=>118.532, 'usuario'=>$usuario )
                );
