...
class CorevatCatPisosSeeder extends Seeder {
	...
	public function run() {
		...
		DB::connection('corevat')->getPdo()->exec("ALTER SEQUENCE cat_pisos_idpiso_seq START WITH 1;");
		DB::connection('corevat')->getPdo()->exec("ALTER SEQUENCE cat_pisos_idpiso_seq RESTART WITH 59;");
	}
