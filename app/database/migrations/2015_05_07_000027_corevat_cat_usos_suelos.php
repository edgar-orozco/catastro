...
class CorevatCatUsosSuelos extends Migration {
	...
	public function up()
	{
		Schema::connection('corevat')->create('cat_usos_suelos', function(Blueprint $table) {
			$table->increments('idusossuelos');
			$table->string('usos_suelos', 50);
			$table->integer('status_usos_suelos')->default(1);
	...
	{
		DB::connection('corevat')->getPdo()->exec("DROP TABLE IF EXISTS cat_usos_suelos CASCADE;");
	}
