...
class CorevatCatTipo extends Migration {
	...
	public function up()
	{
		Schema::connection('corevat')->create('cat_tipo', function(Blueprint $table) {
			$table->increments('idtipo');
			$table->string('tipo', 50);
			$table->integer('status_tipo')->default(1);
	...
	{
		DB::connection('corevat')->getPdo()->exec("DROP TABLE IF EXISTS cat_tipo CASCADE;");
	}
