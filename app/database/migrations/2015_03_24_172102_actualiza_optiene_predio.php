...
class ActualizaOptienePredio extends Migration {
...
RETURNS TABLE (clave VARCHAR, propietario TEXT, municipio VARCHAR, cve_status VARCHAR, des_status VARCHAR , id_requerimiento INTEGER, f_requerimiento TEXT, f_termino TEXT, f_cancelacion TEXT, notificacion INTEGER) 
AS 
$$
DECLARE
	v_consulta	TEXT;
