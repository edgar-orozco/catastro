...
class FunctionSpPredios extends Migration {
	...
	{
		$sql= <<<FinSP
		DROP FUNCTION IF EXISTS sp_get_predios(	IN p_clave TEXT,
...
DB::connection()->getPdo()->exec($sql);
	...
	{
		$sqlp = "DROP FUNCTION IF EXISTS sp_get_predios();";
		DB::connection()->getPdo()->exec($sqlp);
	}
