...
class ActualizaGetPropietarios extends Migration {
	...
	public function up()
	{
		$existe = DB::select("select proname,pg_get_function_arguments(oid) from pg_proc where proname ='sp_get_predios'");
                if(count($existe) > 0) {
                	...
                	DB::statement("DROP FUNCTION sp_get_predios(IN p_clave TEXT, p_nombre_propietario TEXT,p_valor_inicial TEXT,p_valor_final TEXT,p_id_municipio TEXT,p_id_colonia TEXT,p_calle TEXT,p_codigo_postal TEXT,p_id_estatus TEXT,p_anio_periodo TEXT)");
									}
		$funtion= <<<FinSP
