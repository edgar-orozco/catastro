...
class CorevatCatEstadoConservacion extends Migration {
	...
	public function up()
	{
		Schema::connection('corevat')->create('cat_estado_conservacion', function(Blueprint $table) {
			$table->increments('idestadoconservacion');
			$table->string('estado_conservacion', 50);
			$table->integer('status_estado_conservacion')->default(1);
	...
	{
		DB::connection('corevat')->getPdo()->exec("DROP TABLE IF EXISTS cat_estado_conservacion CASCADE;");
	}
