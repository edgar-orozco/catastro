...
class CreaPrediosStatus extends Migration {
...
RETURNS TABLE (clave VARCHAR, propietario TEXT, municipio VARCHAR, cve_status VARCHAR, des_status VARCHAR, f_requerimiento TEXT, f_termino TEXT) 
AS 
$$
DECLARE
	v_consulta	TEXT;
