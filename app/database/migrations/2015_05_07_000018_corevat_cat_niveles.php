...
class CorevatCatNiveles extends Migration {
	...
	public function up()
	{
		Schema::connection('corevat')->create('cat_niveles', function(Blueprint $table) {
			$table->increments('idnivel');
			$table->string('nivel', 50);
			$table->integer('status_nivel')->default(1);
	...
	{
		DB::connection('corevat')->getPdo()->exec("DROP TABLE IF EXISTS cat_niveles CASCADE;");
	}
