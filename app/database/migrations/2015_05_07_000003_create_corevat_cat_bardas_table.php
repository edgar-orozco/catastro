...
class CreateCorevatCatBardasTable extends Migration {
	...
	public function up()
	{
		Schema::connection('corevat')->create('cat_bardas', function(Blueprint $table) {
			$table->increments('idbarda');
			$table->string('barda', 100);
	...
	{
		DB::connection('corevat')->getPdo()->exec("DROP TABLE IF EXISTS cat_bardas CASCADE;");
	}
