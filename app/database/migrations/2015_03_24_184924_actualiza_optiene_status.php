...
class ActualizaOptieneStatus extends Migration {
...
RETURNS TABLE (clave VARCHAR, propietario TEXT, municipio VARCHAR, cve_status VARCHAR, des_status VARCHAR , id_requerimiento INTEGER, f_requerimiento TEXT, f_termino TEXT, f_cancelacion TEXT, notificacion VARCHAR) 
AS 
$$
DECLARE
	v_consulta	TEXT;
BEGIN
	v_consulta := ' 
		  SELECT pf.clave  clave
				 ...
				 , rq.id_requerimiento
				 , to_char(rq.f_notificacion,''DD/MM/YYYY'') f_requerimiento
