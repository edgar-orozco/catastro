...
class CorevatCatMuros extends Migration {
	...
	public function up()
	{
		Schema::connection('corevat')->create('cat_muros', function(Blueprint $table) {
			$table->increments('idmuro');
			$table->string('muro', 100);
			$table->integer('status_muro')->default(1);
	...
	{
		DB::connection('corevat')->getPdo()->exec("DROP TABLE IF EXISTS cat_muros CASCADE;");
	}
