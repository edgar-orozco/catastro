...
class CorevatCatPlafones extends Migration {
	...
	public function up()
	{
		Schema::connection('corevat')->create('cat_plafones', function(Blueprint $table) {
			$table->increments('idplafon');
			$table->string('plafon', 100);
			$table->integer('status_plafon')->default(1);
	...
	{
		DB::connection('corevat')->getPdo()->exec("DROP TABLE IF EXISTS cat_plafones CASCADE;");
	}
