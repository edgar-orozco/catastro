...
class CorevatCatConstrucciones extends Migration {
	...
	public function up()
	{
		Schema::connection('corevat')->create('cat_construcciones', function(Blueprint $table) {
			$table->increments('idconstruccion');
			$table->string('construccion', 100);
			$table->integer('status_construccion')->default(0);
	...
	{
		DB::connection('corevat')->getPdo()->exec("DROP TABLE IF EXISTS cat_construcciones CASCADE;");
	}
