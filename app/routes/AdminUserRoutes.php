...
Route::group(array('before' => 'admin'), function() {
    ...
    Route::post('admin/permission.{format}', array('as' => 'storePermission', 'uses' => 'AdminPermissionsController@store'));
    Route::get('admin/permission.{format}', array('as' => 'indexPermission', 'uses' => 'AdminPermissionsController@index'));
    Route::put('admin/permission/{permission}.{format}', array('as' => 'updatePermission', 'uses' => 'AdminPermissionsController@update'));
