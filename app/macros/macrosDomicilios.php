...
$domicilio = '
            ...
            Form::text($llave.'[cp]', null, ['class' => 'form-control '  .$llave.'-codgio','minlength'=>'5','maxlength'=>'5','pattern'=> '([0-9]{5})','title' => 'El Código Postal ingresado no tiene el formato esperado, verifique nuevamente el Código Postal ingresado']).
            '</div>'.
            '<div class="col-md-6">'.
