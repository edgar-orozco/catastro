...
$domicilio = '
            ...
            Form::text($llave.'[cp]', null, ['class' => 'form-control '  .$llave.'-codgio','pattern' => '[0-9]{5}','title' => 'El Código Postal ingresado no tiene el formato esperado, verifique nuevamente el Código Postal ingresado', 'required'=>'required']).
            '</div>'.
            '<div class="col-md-6">'.
