...
class AdminPermissionsController extends \BaseController
{
    ...
    public function index($format = 'html')
    {
        ...
        return ($format == 'json') ? $permissions : View::make('admin.permission.index',
            compact('title', 'title_section', 'subtitle_section', 'permission', 'permissions'));
    }
    ...
    public function store($format = 'html')
    {
        ...
        if ($format == 'json') {
            return array(
                ...
                'data' => array('id' => $this->permission->id, 'idx' => Input::get('idx'))
            );
        }
        //Se han guardado los valores, expresamos al usuario nuestra felicidad al respecto.
        return Redirect::to('admin/permission/create')->with('success',
            '¡Se ha creado correctamente el permiso: ' . $this->permission->name . " !");
    }
    ...
    public function edit($id)
    {
        ...
        //ID del permiso
        $id = $permission->id;
        return View::make('admin.permission.edit',
            compact('title', 'title_section', 'subtitle_section', 'permission', 'permissions', 'id'));
    }
    ...
    public function update($id, $format = 'html')
    {
        ...
        return Redirect::to('admin/permission/' . $this->permission->id . '/edit')->with('success',
            '¡Se ha actualizado correctamente el permiso: ' . $this->permission->display_name . " !");
    }
